...
import { getCategories, getFeedback, addVocabulary, Category, FeedbackItem } from '../../services/api';
...
export default function AdminDashboard() {
    ...
    const getCategoryColor = (cat: string) => {
        switch (cat) {
            case 'Bug Report': return { bg: '#fef2f2', text: '#dc2626', border: '#fecaca' };
            case 'Feature Request': return { bg: '#eff6ff', text: '#2563eb', border: '#bfdbfe' };
            case 'Content Suggestion': return { bg: colors.successBg, text: '#16a34a', border: colors.successBorder };
            default: return { bg: colors.background, text: colors.textSubtle, border: colors.border };
        }
    };
